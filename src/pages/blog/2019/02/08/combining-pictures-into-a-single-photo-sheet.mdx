...
```
convert input.jpg -gravity north -crop 2:3 +repage output.jpg</code>
```
...
```
# find the size using "identify" identify a.jpg # resize convert input.jpg
-resize 2000x3000 output.jpg
```
