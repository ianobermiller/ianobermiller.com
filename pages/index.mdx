...
child of God and disciple of Jesus in Seattle as a husband,
dad, and software engineer at Facebook.

## Facebook

I&#8217;ve worked in the
[Facebook](http://facebook.com/ianobermiller) Seattle
office, with amazing views of the city and Lake Union, since 2013. Our team is changing the way Facebook approaches and
executes product design with a purpose-built tool using
...
Before Facebook I worked at Microsoft, on teams ranging from
AdCenter to Windows Phone Research and [FUSE
Labs](https://en.wikipedia.org/wiki/microsoft_fuse_labs). At
...
University](https://www.marquette.edu/) and went on to earn
my master’s degree from the University of Washington via the
[Professional Masters
Program](https://www.cs.washington.edu/academics/pmp/). The
...
Occasionally, I [write code to
share](https://github.com/ianobermiller) or attempt to learn
a new programming language. Outside of the digital world, I
love [diving into the awesome Word of
God](https://my.bible.com/users/ianobermiller/highlights),
